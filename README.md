...
├── docs/                                 # <!--count:doc_markdown_files-->444<!--/count--> Markdown documentation files
├── tests/e2e/                            # 260 shell E2E scripts
...
| E2E shell scripts | <!--count:e2e_scripts-->260<!--/count--> | Full-pipeline validation |
