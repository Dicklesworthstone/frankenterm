...
├── tests/e2e/                            # 269 shell E2E scripts
...
| E2E shell scripts | <!--count:e2e_scripts-->269<!--/count--> | Full-pipeline validation |
