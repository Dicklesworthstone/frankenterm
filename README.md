...
├── docs/                                 # 426 Markdown documentation files
├── tests/e2e/                            # 265 shell E2E scripts
...
| E2E shell scripts | <!--count:e2e_scripts-->265<!--/count--> | Full-pipeline validation |
