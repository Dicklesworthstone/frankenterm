...
├── tests/e2e/                            # 266 shell E2E scripts
...
| E2E shell scripts | <!--count:e2e_scripts-->266<!--/count--> | Full-pipeline validation |
