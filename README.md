...
├── tests/e2e/                            # 270 shell E2E scripts
...
| E2E shell scripts | <!--count:e2e_scripts-->270<!--/count--> | Full-pipeline validation |
