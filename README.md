...
├── docs/                                 # <!--count:doc_markdown_files-->454<!--/count--> Markdown documentation files
├── tests/e2e/                            # 267 shell E2E scripts
...
|---|---|---|
| Test annotations | <!--count:test_count-->56347<!--/count-->+ | Module-level correctness, property checks, and async test coverage |
| Core Rust test files | <!--count:core_rust_test_files-->967<!--/count--> | Cross-module behavior under `crates/frankenterm-core/tests/` |
| E2E shell scripts | <!--count:e2e_scripts-->267<!--/count--> | Full-pipeline validation |
| Criterion bench files | <!--count:criterion_bench_files-->111<!--/count--> | Performance regression detection |
| Fuzz targets | <!--count:fuzz_targets-->49<!--/count--> | Security / robustness |
...
*<!--count:workspace_members-->77<!--/count--> workspace crates. <!--count:core_top_level_modules-->512<!--/count--> top-level core modules + <!--count:core_subcrates-->19<!--/count--> sub-crates. <!--count:core_loc-->1025065<!--/count-->+ lines. <!--count:test_count-->56347<!--/count-->+ tests. asupersync-native, Cx-first, `tokio`-banned, `unsafe`-forbidden. One mission: make AI agent swarms observable, controllable, and safe.*
