...
layout, the redaction-and-encryption strategy, and the
recovery-flow contract so each sub-bead can land independently
without re-litigating the architecture. Same pattern as
`docs/design/gpu-regression-harness.md` (under ft-ombfl.1).
