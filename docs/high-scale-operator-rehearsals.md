...
| --- | --- |
| `commands.txt` | Exact command lines in execution order, including the full `RCH_REQUIRE_REMOTE=1 RCH_NO_SELF_HEALING=1 rch --no-self-healing exec -- env CARGO_TARGET_DIR=...` command for Cargo-backed proof. |
