...
gate "deferred proof replay contract"            "tests/e2e/test_deferred_proof_replay_contract.sh"
gate "deferred proof queue schema"               "tests/e2e/test_deferred_proof_queue_schema.sh"
gate "deferred proof admission contract"         "tests/e2e/test_deferred_proof_admission_contract.sh"
gate "deferred proof attach contract"            "tests/e2e/test_deferred_proof_attach_contract.sh"
gate "deferred proof status contract"            "tests/e2e/test_deferred_proof_status_contract.sh"
