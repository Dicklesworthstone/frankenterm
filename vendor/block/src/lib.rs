...
// Apple's Blocks ABI and compiler-rt declare this storage as void *[32].
// Only its address enters BlockBase::isa; Rust never reads its contents.
// UnsafeCell reflects runtime-owned mutable storage without a shared Rust
// reference. This follows block2's inhabited Apple Class representation.
#[repr(C)]
struct Class {
    _storage: std::cell::UnsafeCell<[*mut c_void; 32]>,
}
