...
- **Stable target (re-audited 2026-08-16):** crates.io `fsqlite 0.3.1`, published from tagged commit `1c7a0c4ac03e3b959e5cc15d94abe64c141aab95`; crate checksum `b39c43fac86ad6354ec1db9fac96b5dbac6caca3811f39a0acf8bf10cd1df5a2`. FrankenTerm has no `fsqlite` package today, so this remains a new backend integration rather than an updater bump. The upstream repository's later 0.3.2 development state is not a published stable target.
