...
use frankenterm_core::product_journey_catalog::{
    ...
    JourneyLifecycleV2, JourneyMutationClassV2, JourneyPhaseOutcomeV2, JourneyPhasePreconditionV2,
    JourneyVariant, MAX_PRODUCT_JOURNEY_CATALOG_BYTES, MAX_PRODUCT_JOURNEY_LINEAGE_BYTES,
    ProducerCoverage, ProductJourneyCatalog, ProductJourneyCatalogV2, ProductJourneyDecodeCode,
