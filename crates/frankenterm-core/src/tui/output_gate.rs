...
pub(crate) mod tests {
    ...
    #[should_panic(
        expected = "gated_write_stdout called while output is suppressed — this would corrupt the TUI"
    )]
    ...
    #[cfg(debug_assertions)]
    #[should_panic(
        expected = "gated_write_stderr called while output is suppressed — this would corrupt the TUI"
    )]
