...
impl MuxOperation {
    ...
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::CaptureSelectionAnchor => "capture_selection_anchor",
            Self::ResolveSelectionAnchor => "resolve_selection_anchor",
            Self::ReleaseSelectionAnchor => "release_selection_anchor",
    ...
    pub fn from_cli_operation(operation: &'static str) -> Self {
        match operation {
            ...
            "capture_selection_anchor" => Self::CaptureSelectionAnchor,
            "resolve_selection_anchor" => Self::ResolveSelectionAnchor,
            "release_selection_anchor" => Self::ReleaseSelectionAnchor,
