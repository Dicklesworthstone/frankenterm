...
mod tests {
    ...
    fn apply_diff_scrollback_changed() {
        ...
        assert_eq!(sb.retained_segment_count, 500);
    }
    ...
    fn engine_scrollback_only_dirty_emits_scrollback_diff() {
        ...
        match &diff.diffs[0] {
            SnapshotDiff::PaneScrollbackChanged {
                ...
                assert_eq!(sb.retained_segment_count, 1000);
            }
