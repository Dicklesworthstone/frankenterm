...
pub const DEFAULT_SHADOW_DAYS: u64 =
    frankenterm_core::tuning_config::AuditTuning::DEFAULT_SHADOW_ROLLOUT_DAYS as u64;
...
impl RolloutConfig {
    ...
    #[must_use]
    pub fn from_tuning(tuning: &frankenterm_core::tuning_config::TuningConfig) -> Self {
        Self {
