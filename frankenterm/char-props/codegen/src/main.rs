...
fn generate_nerdfonts_data() {
    let url = "https://raw.githubusercontent.com/ryanoasis/nerd-fonts/1514941a80397d93361f4193346d9cbb9ed21c6e/glyphnames.json";
    ...
    let mut symbols: Vec<(String, char)> = parsed
        .glyphs
        .into_iter()
        .map(|(name, g)| (name.replace("-", "_"), g.glyph_text))
        .collect();
