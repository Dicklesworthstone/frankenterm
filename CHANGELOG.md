...
- Guardian recovery preserves separate authenticated adoptions when successor muxes capture identical terminal content. Exact replay and resumed reads retain the selected capture generation; historical checkpoint files remain available. Subprocess tests cover mux death during durable ownership transfer while the original guardian-owned child remains alive. Automatic whole-mux startup restoration and recovery after guardian or host failure remain unfinished.
